  ...
  return (
    <div className="wrapper py-4 flex items-center justify-between border-b border-b-brown-300">
      ...
      <ul className="flex items-center gap-4">
        <li><NavLink className="[&.active]:underline font-poppins font-medium text-xl text-brown" to="/">Shop</NavLink></li>
        <li><NavLink className="[&.active]:underline font-poppins font-medium text-xl text-brown" to="/login">Login</NavLink></li>
      </ul>
    </div>
  )
}
